(function (nv) {
  ...
  nv.models.customLineWithFocusChart = function () {
    "use strict";
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        var availableWidth = nv.utils.availableWidth(width, container, margin),
          ...
          availableHeight2 = nv.utils.availableHeight(height, container, margin) - height2//height2 - margin2.top - margin2.bottom;
