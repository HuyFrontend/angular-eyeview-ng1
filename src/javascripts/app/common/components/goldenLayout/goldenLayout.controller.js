...
let load = {
  ...
  //   promises.push((() => {
  //     let deferred = $q.defer();
  //     window.OCLAZYLOAD['d3'](() => deferred.resolve());
  //     return deferred.promise;
  //   })());
  //   // ng-table
  //   promises.push((() => {
  //     let deferred = $q.defer();
  //     window.OCLAZYLOAD['ng-table'](() => deferred.resolve());
  //     return deferred.promise;
  //   })());
  //   // lzComponents
  //   promises.push(function () {
  //     let lzComponents = $q.defer();
  //     require.ensure([
  //
  //
  //     ], (require) => {
  ...
  //
  //       ]);
  //       lzComponents.resolve();
  //     });
  //     return lzComponents.promise;
  //   }());
  //   $q.all(promises).then(() => {
  //     deferred.resolve();
  //   });
  ...
  network: ($q, $ocLazyLoad) => {
    ...
    require.ensure([
      ...
      'app/common/services/point/index',
      'app/common/services/resource/index',
      'app/common/services/goldenLayout',
      ...
      let pointService = require('app/common/services/point/index');
      let resourceService = require('app/common/services/resource/index');
      let goldenLayoutService = require('app/common/services/goldenLayout');
      let exportMijiUtiDialog = require('app/common/directives/exportMijiUtiDialog/exportMijiUtiDialog');
      ...
      $ocLazyLoad.load([
        ...
        {name: pointService.default.name},
        {name: markupService.default.name},
        {name: resourceService.default.name},
        {name: goldenLayoutService.default.name},
        {name: exportMijiUtiDialog.default.name},
  ...
  //must be lower case
  viewcamera: ($q, $ocLazyLoad) => {
    let deferred = $q.defer();
    require.ensure([
      'app/common/components/liveCameraView',
      'app/common/components/viewcamera',
      'app/vendors/leaflet',
      'app/common/services/markup/index',
      'app/common/services/notifications',
      'app/common/services/file',
      ...
      require('app/vendors/leaflet');
      let liveCameraViewComponent = require('app/common/components/liveCameraView');
      let viewcameraComponent = require('app/common/components/viewcamera');
      let markupService = require('app/common/services/markup/index');
      let fileService = require('app/common/services/file/index');
      let filesService = require('app/common/services/file');
      let notificationsService = require('app/common/services/notifications');
      ...
      $ocLazyLoad.load([
        {name: liveCameraViewComponent.default.name},
        {name: viewcameraComponent.default.name},
        {name: fileService.default.name},
        {name: notificationsService.default.name},
        {name: debounceService.default.name},
        {name: filesService.default.name},
...
class Controller {
  ...
  constructor($element,
    ...
    this._goldenLayoutService = GoldenLayoutService;
    this.initFlag = false;
  ...
  refresh() {
    ...
    //register component
    this.goldenLayout.registerComponent('networkAngularModule', (container, state) => {
